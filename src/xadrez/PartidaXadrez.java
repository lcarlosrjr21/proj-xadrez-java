...
public class PartidaXadrez {
	...
	private void iniciarPartida() {
		...
		/*
		 * lugarNovaPeca('b', 1, new Cavalo(tabuleiro, Cor.BRANCO)); lugarNovaPeca('c',
		 * 1, new Bispo(tabuleiro, Cor.BRANCO)); lugarNovaPeca('d', 1, new
		 * Rainha(tabuleiro, Cor.BRANCO));
		 */

		// lugarNovaPeca('e', 1, new Rei(tabuleiro, Cor.BRANCO));
		/*
		 * lugarNovaPeca('f', 1, new Bispo(tabuleiro, Cor.BRANCO)); lugarNovaPeca('g',
		 * 1, new Cavalo(tabuleiro, Cor.BRANCO));
		 */
		...
		/*
		 * lugarNovaPeca('b', 8, new Cavalo(tabuleiro, Cor.PRETO)); lugarNovaPeca('c',
		 * 8, new Bispo(tabuleiro, Cor.PRETO)); lugarNovaPeca('d', 8, new
		 * Rainha(tabuleiro, Cor.PRETO));
		 */

		// lugarNovaPeca('e', 8, new Rei(tabuleiro, Cor.PRETO));

		/*
		 * lugarNovaPeca('f', 8, new Bispo(tabuleiro, Cor.PRETO)); lugarNovaPeca('g', 8,
		 * new Cavalo(tabuleiro, Cor.PRETO));
		 */
